//Algorithm programming homework
...
string karatsuba(string x,string y)
{
    ...
    string a,b,c,d,ac,bd,ad,bc,abcd; //abcd = ad+bc
    int n = x.length();
    ...
    return addXY(addXY(mul10(ac,n),mul10(abcd,n/2)),bd);
}
...
int main()
{
    ...
    {
        if(a=="0"||b=="0")  cout<<"0\n";
        else    string res = remZero(karatsuba(a,b));
    }
